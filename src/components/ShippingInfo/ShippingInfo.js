...
const ShippingInfo = ({ totalBill, setOrderPlaced }) => {
      ...
      <div className="shippingInfo">
        ...
        <Form noValidate validated={validated} onSubmit={submitHandler} >
          ...
          <Form.Group className="mb-3" controlId="formBasicCheckbox">
            <Form.Check type="checkbox" label="Save this shipping details for future Orders" name="saveDetail" value={true} onChange={inputChangeHandler} />
          </Form.Group>
