...
function OrderSummary({ setTotalBill }) {
  const cartCtx = useContext(CartContex);
  const subTotal = cartCtx.cartItems.reduce((sum, cartItem) => (
    (cartItem.salePrice * cartItem.quantity) + cartItem.shippingCost
  ) + sum, 0);
      ...
      <div className="orderSummary__content">
        <table>
          <tbody>
            ...
            <tr><td colSpan={3}><hr style={{ backgroundColor: 'gray', height: '2px', margin: '1rem -10px' }} /></td></tr>
            <tr>
              <td colSpan={2}>
                <p>Items Subtotal</p>
              </td>
